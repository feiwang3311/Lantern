  ...
  test("add_tanh") {
    val g1 = new LanternDriverC[String, Unit] with TensorSecOrderApi {
      ...
      def snippet(a: Rep[String]): Rep[Unit] = {
        ...
        // correctness assertion
        Tensor.assertEqual(res, Tensor.scalar(3.891992f))
        Tensor.assertEqual(getGradient(start1), Tensor.fromData(Seq(4), 0.070651f, 0.000182f, 0.070651f, 0.070651f))
        Tensor.assertEqual(getGradient(start2), Tensor.fromData(Seq(4), 0.070651f, 0.000182f, 0.070651f, 0.070651f))
        Tensor.assertEqual(getHessV(start1), Tensor.fromData(Seq(4), -0.081731f, -0.000290f, -0.136219f, -0.163462f))
        Tensor.assertEqual(getHessV(start2), Tensor.fromData(Seq(4), -0.081731f, -0.000290f, -0.136219f, -0.163462f))
  ...
  test("tanh0") {
    val g1 = new LanternDriverC[String, Unit] with TensorSecOrderApi {
      ...
      def snippet(a: Rep[String]): Rep[Unit] = {
        ...
        // correctness assertion
        Tensor.assertEqual(res, Tensor.scalar(3.720006f))
        Tensor.assertEqual(getGradient(start1), Tensor.fromData(Seq(4), 0.419974f, 0.070651f, 0.009866f, 0.001341f))
        Tensor.assertEqual(getHessV(start1), Tensor.fromData(Seq(4), -0.255880f, -0.068109f, -0.011781f, -0.001876f))
        // PyTorch equvilent code
  ...
  test("conv1") { // for input
    val g1 = new LanternDriverC[String, Unit] with TensorSecOrderApi {
      ...
      def snippet(a: Rep[String]): Rep[Unit] = {
        ...
        // correctness assertion
        Tensor.assertEqual(res, Tensor.scalar(0.711658f))
        Tensor.assertEqual(getGradient(input),
          Tensor.fromData(Seq(1,1,2,2), 0.087642f, 0.075560f, -0.224213f, 0.218349f))
        Tensor.assertEqual(getHessV(input),
  ...
  test("vv_dot3") {
    val g1 = new LanternDriverC[String, Unit] with TensorSecOrderApi {
      ...
      def snippet(a: Rep[String]): Rep[Unit] = {
        ...
        // correctness assertion
        Tensor.assertEqual(res, Tensor.scalar(0.707955f))
        Tensor.assertEqual(getGradient(input),
        ...
        Tensor.assertEqual(getGradient(bias), Tensor.scalar(0.498800f))
        Tensor.assertEqual(getHessV(input),
  ...
  test("conv3") { // for both kernel and input, larger pane of input
    val g1 = new LanternDriverC[String, Unit] with TensorSecOrderApi {
      ...
      def snippet(a: Rep[String]): Rep[Unit] = {
        ...
        // correctness assertion
        Tensor.assertEqual(res, Tensor.scalar(-0.692684f))
        Tensor.assertEqual(getGradient(input),
  ...
  test("conv4") { // for both kernel and input, multiple channels
    val g1 = new LanternDriverC[String, Unit] with TensorSecOrderApi {
      ...
      def snippet(a: Rep[String]): Rep[Unit] = {
        ...
        // correctness assertion
        Tensor.assertEqual(res, Tensor.scalar(-0.012916f))
        Tensor.assertEqual(getGradient(input),
  ...
  test("conv5") { // for both kernel and input, multiple channels and batches
    val g1 = new LanternDriverC[String, Unit] with TensorSecOrderApi {
      ...
      def snippet(a: Rep[String]): Rep[Unit] = {
        ...
        // correctness assertion
        Tensor.assertEqual(res, Tensor.scalar(0.276402f))
        Tensor.assertEqual(getGradient(input),
  ...
  test("conv6") { // for both kernel and input, multiple channels and batches and bias
    val g1 = new LanternDriverC[String, Unit] with TensorSecOrderApi {
      ...
      def snippet(a: Rep[String]): Rep[Unit] = {
        ...
        // correctness assertion
        Tensor.assertEqual(res, Tensor.scalar(0.816457f))
        Tensor.assertEqual(getGradient(input),
          Tensor.fromData(Seq(2,3,2,2),
        ...
        Tensor.assertEqual(getGradient(bias), Tensor.fromData(Seq(3), 1.653047f, 1.430667f, 1.719234f))
        Tensor.assertEqual(getHessV(input),
          Tensor.fromData(Seq(2,3,2,2),
        ...
        Tensor.assertEqual(getHessV(bias), Tensor.fromData(Seq(3), -2.636025f, 1.164155f, 2.572128f))
        // PyTorch equvilent code
        // torch.manual_seed(999)
