...
class ResNetCifar10(nn.Module):
    ...
    def __init__(self, block, layers, num_classes = 10):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool2d(kernel_size = 2, stride= 2)  # 16 * 16
        ...
        self.avgpool = nn.AvgPool2d(2, stride=1) # 1 * 1
...
def resnet50Cifar10(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model for Cifar10 dataset.
