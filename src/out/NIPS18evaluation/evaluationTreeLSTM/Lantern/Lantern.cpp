...
float** x2178 = (float**)myMalloc(6 * sizeof(float*));;
x2178[0] = x236;
x2178[1] = x237;
x2178[2] = x238;
x2178[3] = x239;
...
float x2187 = x235[0];
float x2188 = x222;
float x2189 = (float)x223;
float x2190 = x2188 * x2189;
int32_t x2191 = x223 + 1;
float x2192 = (float)x2191;
float x2193 = x2190 / x2192;
float x2194 = x2187 / x2192;
float x2195 = x2193 + x2194;
x222 = x2195;
for(int x2197=0; x2197 < 45000; x2197++) {
float x2198 = x173[x2197];
float x2199 = x2198;
float x2200 = x195[x2197];
float x2201 = x2199;
float x2202 = x2201 * x2201;
float x2203 = x2200 + x2202;
x195[x2197] = x2203;
float x2205 = x50[x2197];
float x2207 = x195[x2197];
float x2206 = 0.05f * x2201;
double x2208 = (double)x2207;
double x2209 = x2208 + 9.99999993922529E-9;
double x2210 = sqrt(x2209);
float x2211 = (float)x2210;
float x2212 = x2206 / x2211;
float x2213 = x2205 - x2212;
x50[x2197] = x2213;
x173[x2197] = 0.0f;

}
for(int x2218=0; x2218 < 150; x2218++) {
float x2219 = x174[x2218];
float x2220 = x2219;
float x2221 = x196[x2218];
float x2222 = x2220;
float x2223 = x2222 * x2222;
float x2224 = x2221 + x2223;
x196[x2218] = x2224;
float x2226 = x59[x2218];
float x2228 = x196[x2218];
float x2227 = 0.05f * x2222;
double x2229 = (double)x2228;
double x2230 = x2229 + 9.99999993922529E-9;
double x2231 = sqrt(x2230);
float x2232 = (float)x2231;
float x2233 = x2227 / x2232;
float x2234 = x2226 - x2233;
x59[x2218] = x2234;
x174[x2218] = 0.0f;

}
for(int x2239=0; x2239 < 45000; x2239++) {
float x2240 = x175[x2239];
float x2241 = x2240;
float x2242 = x197[x2239];
float x2243 = x2241;
float x2244 = x2243 * x2243;
float x2245 = x2242 + x2244;
x197[x2239] = x2245;
float x2247 = x60[x2239];
float x2249 = x197[x2239];
float x2248 = 0.05f * x2243;
double x2250 = (double)x2249;
double x2251 = x2250 + 9.99999993922529E-9;
double x2252 = sqrt(x2251);
float x2253 = (float)x2252;
float x2254 = x2248 / x2253;
float x2255 = x2247 - x2254;
x60[x2239] = x2255;
x175[x2239] = 0.0f;

}
for(int x2260=0; x2260 < 150; x2260++) {
float x2261 = x176[x2260];
float x2262 = x2261;
float x2263 = x198[x2260];
float x2264 = x2262;
float x2265 = x2264 * x2264;
float x2266 = x2263 + x2265;
x198[x2260] = x2266;
float x2268 = x68[x2260];
float x2270 = x198[x2260];
float x2269 = 0.05f * x2264;
double x2271 = (double)x2270;
double x2272 = x2271 + 9.99999993922529E-9;
double x2273 = sqrt(x2272);
float x2274 = (float)x2273;
float x2275 = x2269 / x2274;
float x2276 = x2268 - x2275;
x68[x2260] = x2276;
x176[x2260] = 0.0f;

}
for(int x2281=0; x2281 < 45000; x2281++) {
float x2282 = x177[x2281];
float x2283 = x2282;
float x2284 = x199[x2281];
float x2285 = x2283;
float x2286 = x2285 * x2285;
float x2287 = x2284 + x2286;
x199[x2281] = x2287;
float x2289 = x69[x2281];
float x2291 = x199[x2281];
float x2290 = 0.05f * x2285;
...
float x2303 = x178[x2302];
float x2304 = x2303;
float x2305 = x200[x2302];
float x2306 = x2304;
float x2307 = x2306 * x2306;
float x2308 = x2305 + x2307;
x200[x2302] = x2308;
float x2310 = x77[x2302];
float x2312 = x200[x2302];
float x2311 = 0.05f * x2306;
double x2313 = (double)x2312;
double x2314 = x2313 + 9.99999993922529E-9;
double x2315 = sqrt(x2314);
float x2316 = (float)x2315;
float x2317 = x2311 / x2316;
float x2318 = x2310 - x2317;
x77[x2302] = x2318;
x178[x2302] = 0.0f;

}
for(int x2323=0; x2323 < 22500; x2323++) {
float x2324 = x179[x2323];
float x2325 = x2324;
float x2326 = x201[x2323];
float x2327 = x2325;
float x2328 = x2327 * x2327;
float x2329 = x2326 + x2328;
x201[x2323] = x2329;
float x2331 = x78[x2323];
float x2333 = x201[x2323];
float x2332 = 0.05f * x2327;
double x2334 = (double)x2333;
double x2335 = x2334 + 9.99999993922529E-9;
double x2336 = sqrt(x2335);
float x2337 = (float)x2336;
float x2338 = x2332 / x2337;
float x2339 = x2331 - x2338;
x78[x2323] = x2339;
x179[x2323] = 0.0f;

}
for(int x2344=0; x2344 < 22500; x2344++) {
float x2345 = x180[x2344];
float x2346 = x2345;
float x2347 = x202[x2344];
float x2348 = x2346;
float x2349 = x2348 * x2348;
float x2350 = x2347 + x2349;
x202[x2344] = x2350;
float x2352 = x87[x2344];
float x2354 = x202[x2344];
float x2353 = 0.05f * x2348;
double x2355 = (double)x2354;
double x2356 = x2355 + 9.99999993922529E-9;
double x2357 = sqrt(x2356);
float x2358 = (float)x2357;
float x2359 = x2353 / x2358;
float x2360 = x2352 - x2359;
x87[x2344] = x2360;
x180[x2344] = 0.0f;

}
for(int x2365=0; x2365 < 150; x2365++) {
float x2366 = x181[x2365];
float x2367 = x2366;
float x2368 = x203[x2365];
float x2369 = x2367;
float x2370 = x2369 * x2369;
float x2371 = x2368 + x2370;
x203[x2365] = x2371;
float x2373 = x95[x2365];
float x2375 = x203[x2365];
float x2374 = 0.05f * x2369;
double x2376 = (double)x2375;
double x2377 = x2376 + 9.99999993922529E-9;
double x2378 = sqrt(x2377);
float x2379 = (float)x2378;
float x2380 = x2374 / x2379;
float x2381 = x2373 - x2380;
x95[x2365] = x2381;
x181[x2365] = 0.0f;

}
for(int x2386=0; x2386 < 22500; x2386++) {
float x2387 = x182[x2386];
float x2388 = x2387;
float x2389 = x204[x2386];
float x2390 = x2388;
float x2391 = x2390 * x2390;
float x2392 = x2389 + x2391;
x204[x2386] = x2392;
float x2394 = x96[x2386];
float x2396 = x204[x2386];
float x2395 = 0.05f * x2390;
double x2397 = (double)x2396;
double x2398 = x2397 + 9.99999993922529E-9;
double x2399 = sqrt(x2398);
float x2400 = (float)x2399;
float x2401 = x2395 / x2400;
float x2402 = x2394 - x2401;
x96[x2386] = x2402;
x182[x2386] = 0.0f;

}
for(int x2407=0; x2407 < 22500; x2407++) {
float x2408 = x183[x2407];
float x2409 = x2408;
float x2410 = x205[x2407];
float x2411 = x2409;
float x2412 = x2411 * x2411;
float x2413 = x2410 + x2412;
x205[x2407] = x2413;
float x2415 = x104[x2407];
float x2417 = x205[x2407];
float x2416 = 0.05f * x2411;
double x2418 = (double)x2417;
double x2419 = x2418 + 9.99999993922529E-9;
double x2420 = sqrt(x2419);
float x2421 = (float)x2420;
float x2422 = x2416 / x2421;
float x2423 = x2415 - x2422;
x104[x2407] = x2423;
x183[x2407] = 0.0f;

}
for(int x2428=0; x2428 < 22500; x2428++) {
float x2429 = x184[x2428];
float x2430 = x2429;
float x2431 = x206[x2428];
float x2432 = x2430;
float x2433 = x2432 * x2432;
float x2434 = x2431 + x2433;
x206[x2428] = x2434;
float x2436 = x112[x2428];
float x2438 = x206[x2428];
float x2437 = 0.05f * x2432;
double x2439 = (double)x2438;
double x2440 = x2439 + 9.99999993922529E-9;
double x2441 = sqrt(x2440);
float x2442 = (float)x2441;
float x2443 = x2437 / x2442;
float x2444 = x2436 - x2443;
x112[x2428] = x2444;
x184[x2428] = 0.0f;

}
for(int x2449=0; x2449 < 22500; x2449++) {
float x2450 = x185[x2449];
float x2451 = x2450;
float x2452 = x207[x2449];
float x2453 = x2451;
float x2454 = x2453 * x2453;
float x2455 = x2452 + x2454;
x207[x2449] = x2455;
float x2457 = x120[x2449];
float x2459 = x207[x2449];
float x2458 = 0.05f * x2453;
double x2460 = (double)x2459;
double x2461 = x2460 + 9.99999993922529E-9;
double x2462 = sqrt(x2461);
float x2463 = (float)x2462;
float x2464 = x2458 / x2463;
float x2465 = x2457 - x2464;
x120[x2449] = x2465;
x185[x2449] = 0.0f;

}
for(int x2470=0; x2470 < 150; x2470++) {
float x2471 = x186[x2470];
float x2472 = x2471;
float x2473 = x208[x2470];
float x2474 = x2472;
float x2475 = x2474 * x2474;
float x2476 = x2473 + x2475;
x208[x2470] = x2476;
float x2478 = x128[x2470];
float x2480 = x208[x2470];
float x2479 = 0.05f * x2474;
double x2481 = (double)x2480;
double x2482 = x2481 + 9.99999993922529E-9;
double x2483 = sqrt(x2482);
float x2484 = (float)x2483;
float x2485 = x2479 / x2484;
float x2486 = x2478 - x2485;
x128[x2470] = x2486;
x186[x2470] = 0.0f;

}
for(int x2491=0; x2491 < 22500; x2491++) {
float x2492 = x187[x2491];
float x2493 = x2492;
float x2494 = x209[x2491];
float x2495 = x2493;
float x2496 = x2495 * x2495;
float x2497 = x2494 + x2496;
x209[x2491] = x2497;
float x2499 = x129[x2491];
float x2501 = x209[x2491];
float x2500 = 0.05f * x2495;
double x2502 = (double)x2501;
double x2503 = x2502 + 9.99999993922529E-9;
double x2504 = sqrt(x2503);
float x2505 = (float)x2504;
float x2506 = x2500 / x2505;
float x2507 = x2499 - x2506;
x129[x2491] = x2507;
x187[x2491] = 0.0f;

}
for(int x2512=0; x2512 < 22500; x2512++) {
float x2513 = x188[x2512];
float x2514 = x2513;
float x2515 = x210[x2512];
float x2516 = x2514;
float x2517 = x2516 * x2516;
float x2518 = x2515 + x2517;
x210[x2512] = x2518;
float x2520 = x137[x2512];
float x2522 = x210[x2512];
float x2521 = 0.05f * x2516;
double x2523 = (double)x2522;
double x2524 = x2523 + 9.99999993922529E-9;
double x2525 = sqrt(x2524);
float x2526 = (float)x2525;
float x2527 = x2521 / x2526;
float x2528 = x2520 - x2527;
x137[x2512] = x2528;
x188[x2512] = 0.0f;

}
for(int x2533=0; x2533 < 150; x2533++) {
float x2534 = x189[x2533];
float x2535 = x2534;
float x2536 = x211[x2533];
float x2537 = x2535;
float x2538 = x2537 * x2537;
float x2539 = x2536 + x2538;
x211[x2533] = x2539;
float x2541 = x145[x2533];
float x2543 = x211[x2533];
float x2542 = 0.05f * x2537;
double x2544 = (double)x2543;
double x2545 = x2544 + 9.99999993922529E-9;
double x2546 = sqrt(x2545);
float x2547 = (float)x2546;
float x2548 = x2542 / x2547;
float x2549 = x2541 - x2548;
x145[x2533] = x2549;
x189[x2533] = 0.0f;

}
for(int x2554=0; x2554 < 22500; x2554++) {
float x2555 = x190[x2554];
float x2556 = x2555;
float x2557 = x212[x2554];
float x2558 = x2556;
float x2559 = x2558 * x2558;
float x2560 = x2557 + x2559;
x212[x2554] = x2560;
float x2562 = x146[x2554];
float x2564 = x212[x2554];
float x2563 = 0.05f * x2558;
double x2565 = (double)x2564;
double x2566 = x2565 + 9.99999993922529E-9;
double x2567 = sqrt(x2566);
float x2568 = (float)x2567;
float x2569 = x2563 / x2568;
float x2570 = x2562 - x2569;
x146[x2554] = x2570;
x190[x2554] = 0.0f;

}
for(int x2575=0; x2575 < 22500; x2575++) {
float x2576 = x191[x2575];
float x2577 = x2576;
float x2578 = x213[x2575];
float x2579 = x2577;
float x2580 = x2579 * x2579;
float x2581 = x2578 + x2580;
x213[x2575] = x2581;
float x2583 = x154[x2575];
float x2585 = x213[x2575];
float x2584 = 0.05f * x2579;
double x2586 = (double)x2585;
double x2587 = x2586 + 9.99999993922529E-9;
double x2588 = sqrt(x2587);
float x2589 = (float)x2588;
float x2590 = x2584 / x2589;
float x2591 = x2583 - x2590;
x154[x2575] = x2591;
x191[x2575] = 0.0f;

}
for(int x2596=0; x2596 < 150; x2596++) {
float x2597 = x192[x2596];
float x2598 = x2597;
float x2599 = x214[x2596];
float x2600 = x2598;
float x2601 = x2600 * x2600;
float x2602 = x2599 + x2601;
x214[x2596] = x2602;
float x2604 = x162[x2596];
float x2606 = x214[x2596];
float x2605 = 0.05f * x2600;
double x2607 = (double)x2606;
double x2608 = x2607 + 9.99999993922529E-9;
double x2609 = sqrt(x2608);
float x2610 = (float)x2609;
float x2611 = x2605 / x2610;
float x2612 = x2604 - x2611;
x162[x2596] = x2612;
x192[x2596] = 0.0f;

}
for(int x2617=0; x2617 < 750; x2617++) {
float x2618 = x193[x2617];
float x2619 = x2618;
float x2620 = x215[x2617];
float x2621 = x2619;
float x2622 = x2621 * x2621;
float x2623 = x2620 + x2622;
x215[x2617] = x2623;
float x2625 = x163[x2617];
float x2627 = x215[x2617];
float x2626 = 0.05f * x2621;
double x2628 = (double)x2627;
double x2629 = x2628 + 9.99999993922529E-9;
double x2630 = sqrt(x2629);
float x2631 = (float)x2630;
float x2632 = x2626 / x2631;
float x2633 = x2625 - x2632;
x163[x2617] = x2633;
x193[x2617] = 0.0f;

}
for(int x2638=0; x2638 < 5; x2638++) {
float x2639 = x194[x2638];
float x2640 = x2639;
float x2641 = x216[x2638];
float x2642 = x2640;
float x2643 = x2642 * x2642;
float x2644 = x2641 + x2643;
x216[x2638] = x2644;
float x2646 = x172[x2638];
float x2648 = x216[x2638];
float x2647 = 0.05f * x2642;
double x2649 = (double)x2648;
double x2650 = x2649 + 9.99999993922529E-9;
double x2651 = sqrt(x2650);
float x2652 = (float)x2651;
float x2653 = x2647 / x2652;
float x2654 = x2646 - x2653;
x172[x2638] = x2654;
x194[x2638] = 0.0f;

}
int64_t x2659 = (long)mallocAddr;
int64_t x2660 = x2659 - x218;
memset((void*)x218, 0, x2660);
mallocAddr = (void*)x218;

}
float x2665 = x222;
double x2666 = (double)x2665;
x217[x221] = x2666;
double x2668 = ((double)clock() / CLOCKS_PER_SEC);
double x2669 = x2668 - x219;
printf("epoc %d, average_loss %f, time %lf\n",x221,x2665,x2669);

}
double x2673 = ((double)clock() / CLOCKS_PER_SEC);
int64_t x2677 = (long)fopen(x0, "w");
fprintf((FILE *)x2677, "unit: %s\n", "1 epoch");
for(int x2679=0; x2679 < 6; x2679++) {
double x2680 = x217[x2679];
fprintf((FILE *)x2677, "%lf\n", x2680);

}
double x2674 = x219 - x2;
double x2675 = x2673 - x219;
double x2676 = x2675 / 6.0;
fprintf((FILE *)x2677, "run time: %lf %lf\n", x2674, x2676);
fclose((FILE*)x2677);
// Backend cleanup.
}
/*****************************************
